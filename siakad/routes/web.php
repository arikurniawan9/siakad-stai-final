...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('admin')->name('admin.')->group(function () {
        ...
        // -----------------------------------------------------------------
        // A. HANYA SUPERADMIN (DEVELOPER / PUSAT KONTROL TEKNIS & TELEMETRI)
        // -----------------------------------------------------------------
        ...
        // -----------------------------------------------------------------
        // B. KEUANGAN (SUPERADMIN & BIRO KEUANGAN)
        // -----------------------------------------------------------------
        ...
        // -----------------------------------------------------------------
        // C. PMB ADMIN (SUPERADMIN, ADMIN AKADEMIK, KEUANGAN)
        // -----------------------------------------------------------------
        Route::middleware('role:superadmin,admin_akademik,keuangan')->group(function () {
        ...
        // -----------------------------------------------------------------
        // D. MANAJEMEN AKADEMIK PUSAT (SUPERADMIN & ADMIN BAAK)
        // -----------------------------------------------------------------
        Route::middleware('role:superadmin,admin_akademik')->group(function () {
            // Master Pengguna (CRUD & Batch Import Excel)
            ...
            // Kebijakan Akademik (Bobot Nilai, SKS Maksimum, Predikat Kelulusan, Gelar Kelulusan)
            ...
            // Data Pejabat Kampus & Penugasan Pengesah
        ...
        // -----------------------------------------------------------------
        // E. STRUKTUR KURIKULUM & MANAJEMEN PRODI (SUPERADMIN, ADMIN AKADEMIK, KAPRODI)
        // 🔒 PERHATIAN: DOSEN PENGAMPU & DOSEN PA DIBLOKIR DARI MODUL INI
        // -----------------------------------------------------------------
        Route::middleware('role:superadmin,admin_akademik,kaprodi')->group(function () {
            // Struktur Kurikulum OBE, Matakuliah & Pemetaan Semester
            ...
            // Hasil Studi (KHS) & Transkrip Akademik
            ...
            // Yudisium & Kelulusan (Tugas Akhir, Wisuda, Surat Keterangan Lulus)
            ...
            // Aktivitas Mahasiswa & Status Kuliah
            ...
            // Executive Dashboard & Akreditasi Analytics (LAMDIK / BAN-PT)
            Route::get('/analytics', [AnalyticsController::class, 'index'])->name('analytics.index');
            Route::get('/analytics/export', [AnalyticsController::class, 'export'])->name('analytics.export');
        });

        // -----------------------------------------------------------------
        // F. BIMBINGAN AKADEMIK & APPROVAL KRS (SUPERADMIN, ADMIN AKADEMIK, KAPRODI, DOSEN PA)
        ...
        // -----------------------------------------------------------------
        // H. PUSAT PENGUMUMAN & BROADCAST
        // -----------------------------------------------------------------
        Route::middleware('role:superadmin,admin_akademik,kaprodi,dosen,dosen_pa,keuangan')->group(function () {
    ...
    // =====================================================================
    // 4. STUDENT (MAHASISWA) MODULES (PROTECTED BY ROLE MIDDLEWARE)
    // =====================================================================
    Route::prefix('student')->name('student.')->middleware('role:superadmin,mahasiswa')->group(function () {
        // KRS Online
